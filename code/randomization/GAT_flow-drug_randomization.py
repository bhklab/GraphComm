...
matrix = pd.read_csv("/h/soemily/GAT/data/Pre_Post/GSE150949/pc9_t0.csv",index_col=0)
...
Omnipath_database = pd.read_csv("/h/soemily/GAT/data/LR_database/intercell_Omnipath.csv",index_col=0)
...
for i in range(5):
    if i % 10 == 0:
        print(i)
    new_day_0_list[i].drop_duplicates().head(1500).to_csv(f"/h/soemily/GAT/results/Pre_Post/GSE150949/Day0_{i+96}_random.csv") 
    new_rep_1_list[i].drop_duplicates().head(1500).to_csv(f"/h/soemily/GAT/results/Pre_Post/GSE150949/Rep1_{i+96}_random.csv")
    new_rep_2_list[i].drop_duplicates().head(1500).to_csv(f"/h/soemily/GAT/results/Pre_Post/GSE150949/Rep2_{i+96}_random.csv")
