...
adata = sc.read_h5ad("/data/GraphComm_Input/Cardiac_cells/Visium-FZ_GT_P19.h5ad")
...
for i in range(10):
    ...
    df_list.append(get_cell_LR_embeddings(matrix,meta,nodes,interactions,df,Omnipath_nodes,Omnipath_interactions,spatial="/data/Cardiac_cells/Visium-FZ_GT_P19.h5ad"))
    print("Done cell embeddings")


# In[74]:
os.system("mkdir -p /results/Cardiac_cells")
...
for i in range(len(df_list)):
    ...
    temp = temp.head(1000)
    temp.to_csv(f"/results/Cardiac_cells/{i+91}_random.csv")
